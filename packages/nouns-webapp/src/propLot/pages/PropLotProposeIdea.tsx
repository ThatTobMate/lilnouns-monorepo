        ...
        >
          ...
          <div className="flex flex-col my-[16px]">
            ...
            <textarea
              ...
              placeholder="In the simplest language possible, describe your proposal in a few sentences..."
            />
          </div>
          <div className="flex flex-col my-[16px]">
            <div className="flex justify-between w-full items-center">
            ...
            {descriptionTab === 'WRITE' ? (
              <textarea
                ...
                placeholder="Describe your proposal in full..."
              />
            ) : (
              <div
                className="border rounded-lg p-2 min-h-[240px]"
